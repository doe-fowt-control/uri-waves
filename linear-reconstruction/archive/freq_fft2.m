function [stat] = freq_fft2(param, stat, eta_)
% stat.[w, k, A, phi, c_g1, c_g2]
...
[pxx, f] = pwelch(eta_(i1 - (i2 - i1):i2, mg), wwindow, noverlap, nfft, fs);
wc = 2*pi*f;
...
stat.c_g1 = 9.81 / (wc(lo_idx)*2);
stat.c_g2 = 9.81 / (wc(hi_idx)*2);
